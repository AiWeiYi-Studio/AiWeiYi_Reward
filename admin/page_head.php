        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-account-settings-variant"></i>系统信息配置</a>
              <ul class="nav nav-subnav">
              <li><a href="./set_site.php">网站信息配置</a></li>
              <li><a href="./set_notice.php">网站公告配置</a></li>
              <li><a href="./set_mail.php">邮件发信配置</a></li>
              <li><a href="./set_chat.php?mod=user">用户聊天配置</a></li>
              <li><a href="./set_pay.php">支付接口配置</a></li>
              <li><a href="./set_shop.php">商城价格配置</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-account-settings-variant"></i>快捷登录配置</a>
              <ul class="nav nav-subnav">
              <li><a href="./set_oauth.php?mod=qq">QQ登录配置</a><li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-account-settings-variant"></i>系统订单配置</a>
              <ul class="nav nav-subnav">
              <li><a href="./set_orders.php">系统订单发布</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-account-settings-variant"></i>个人信息配置</a>
              <ul class="nav nav-subnav">
              <li><a href="./my_info.php">我的个人信息</a></li>
              <li><a href="./my_edit.php">修改个人资料</a></li>
              <li><a href="./my_oauth.php">快捷登录信息</a><li>
              <li><a href="./my_avatar.php">个人头像配置</a><li>
              <li><a href="./my_log.php?uid=<?php echo $udata['uid'];?>">我的操作日志</a></li>
              </ul>
            </li>
          </ul>
        </nav>
